...
async def h2h_table(data, match_vs, surface, indice_tab, session, admin_url, header, match_id):
    ...
    if go != "":
        await indice_confiance(indice_tab, session, admin_url, header, "", match_id, surface, flag, "Tactique", go)